...
public class UserController {
    ...
    public ResponseEntity<Void> createAccount(@PathVariable("id") String userId,
    ...
    public ResponseEntity<List<AccountResponseDto>> listAccounts(@PathVariable("id") String userId) {
